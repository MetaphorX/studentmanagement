...
const MoreStuff = () => {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <h1 className="sm:text-3xl text-2xl font-medium title-font text-green-900">
        Emergency Sections
      </h1>
    </div>
      ...
      <div className="p-4 md:w-1/3">
        <div className="flex rounded-lg h-full bg-gray-100 p-8 flex-col">
          ...
          <div className="flex-grow">
            ...
            <Link to={'/tips'} className="mt-3 text-green-500 inline-flex items-center">
              Learn More
              <svg
                fill="none"
                stroke="currentColor"
